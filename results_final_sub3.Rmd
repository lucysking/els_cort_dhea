...
ggsave("~/Box/lucy_king_files/ELS/cort_dhea/cort_dhea_sync/interval_dist.png", width = 7, height = 5)
```
...
ggsave("~/Box/lucy_king_files/ELS/cort_dhea/cort_dhea_sync/tanner_dist.png", width = 7, height = 5)
...
ggsave("~/Box/lucy_king_files/ELS/cort_dhea/cort_dhea_sync/tanner_change.png", width = 7, height = 5)
